 ...
 * This element contains current selected site theme.
 */
export const CURRENT_THEME_KEY = 'UKSIVT_CurrentTheme';

/**
 * Contains key of the local storage element.
 * This element contains current user settings.
 */
export const USER_SETTINGS_KEY = 'UKSIVT_CurrentUserSettings';
